const zh = {
    ...
    ,apiDomains: 'API 可用域名'
    ,apiWildcardDomains: '通配子域'
    ,apiWildcardDomainsDesc: '启用前请确认 Cloudflare Email Routing 与通配 MX 已配置；本应用不会自动配置 DNS。'
    ,apiKeyName: '密钥名称'
    ,apiScopes: '权限范围'
    ,createApiKey: '创建 API 密钥'
    ,deleteApiKey: '删除 API 密钥'
    ,deleteApiKeyWarning: '删除 API 密钥“{msg}”会同时删除其创建的全部临时邮箱、邮件和附件，是否继续？'
    ,apiKeyTodayCalls: '今日调用'
    ,apiKeyLast30DaysCalls: '近 30 天调用'
    ,apiKeySecretWarning: '请立即复制该密钥，关闭后无法再次查看。'
    ,apiScopeInboxesRead: '临时邮箱：查看'
    ,apiScopeInboxesWrite: '临时邮箱：创建和删除'
    ,apiScopeMessagesRead: '邮件：查看和下载'
    ,apiScopeMessagesWrite: '邮件：标记和删除'
    ,apiUsageGuide: '使用说明'
    ...
    ,temporaryInbox: '临时邮箱'
    ,createTemporaryInbox: '创建临时邮箱'
    ,temporaryInboxApiKey: 'API 密钥'
    ,temporaryInboxLocalPart: '邮箱前缀'
    ,temporaryInboxDomain: '邮箱域名'
    ,temporaryInboxKeyRequired: '请先创建具有“临时邮箱：创建和删除”权限的 API 密钥'
    ,expiresAt: '到期时间'
    ,messageCount: '邮件数量'
    ...
    ,outlookMailboxManagement: '邮箱管理'
    ,outlookAccountPool: '账号池'
    ,outlookGroupManagement: '分组管理'
    ,outlookMailService: '邮件服务'
    ,outlookAuthorize: 'OAuth 授权'
    ,outlookImport: '批量导入'
    ,outlookImportRows: '每行：邮箱----密码----client_id----令牌'
    ,outlookGraphImportHint: '导入将使用 Microsoft Graph；邮箱和 client_id 必须与 refresh token 对应。机密客户端需在部署中为同一 client_id 配置 Client Secret；密码字段仅为兼容格式，会被丢弃。'
    ,outlookImportResult: '导入结果'
    ,outlookExport: '导出'
    ,outlookExportAll: '导出全部'
    ,outlookExportSelected: '导出选中'
    ,outlookExportEmpty: '没有可导出的 Outlook 账号'
    ,outlookGroup: '分组'
    ,outlookTags: '标签'
    ,outlookManageTags: '标签管理'
    ,outlookManageMembers: '管理账号'
    ,outlookSync: '立即同步'
    ,outlookSyncStatus: '同步状态'
    ,outlookSyncError: '同步错误'
    ,outlookLastSync: '最后同步'
    ,outlookReceivedCount: '已接收邮件'
    ,outlookReady: '就绪'
    ,outlookSyncing: '同步中'
    ,outlookError: '错误'
    ,outlookNewGroup: '新建分组'
    ,outlookNewTag: '新建标签'
    ,outlookName: '名称'
    ,outlookAccounts: '账号'
    ,outlookNoAccounts: '暂无 Outlook 账号'
