const en = {
    ...
    ,apiWildcardDomains: 'Wildcard subdomains'
    ,apiWildcardDomainsDesc: 'Enable only after Cloudflare Email Routing and wildcard MX are configured; this application does not provision DNS.'
    ,apiKeyName: 'Key Name'
    ,apiScopes: 'Scopes'
    ,createApiKey: 'Create API Key'
    ,deleteApiKey: 'Delete API Key'
    ,deleteApiKeyWarning: 'Deleting API key “{msg}” also deletes every temporary inbox, message, and attachment it created. Continue?'
    ,apiKeyTodayCalls: 'Today calls'
    ,apiKeyLast30DaysCalls: 'Last 30 days'
    ...
    ,createTemporaryInbox: 'Create Temporary Inbox'
    ,temporaryInboxApiKey: 'API Key'
    ,temporaryInboxLocalPart: 'Mailbox Prefix'
    ,temporaryInboxDomain: 'Mailbox Domain'
    ,temporaryInboxKeyRequired: 'Create an API key with the Manage inboxes scope first.'
    ...
    ,outlookGroupManagement: 'Group Management'
    ...
    ,outlookGraphImportHint: 'Imports use Microsoft Graph. The mailbox and client ID must match the refresh token. Confidential clients need the matching deployed client secret; the password field is discarded for format compatibility.'
    ,outlookImportResult: 'Import Result'
    ,outlookExport: 'Export'
    ,outlookExportAll: 'Export All'
    ,outlookExportSelected: 'Export Selected'
    ,outlookExportEmpty: 'No Outlook accounts to export'
    ,outlookGroup: 'Group'
    ,outlookTags: 'Tags'
    ,outlookManageTags: 'Manage Tags'
    ,outlookManageMembers: 'Manage Accounts'
    ,outlookSync: 'Sync Now'
    ,outlookSyncStatus: 'Sync Status'
    ,outlookSyncError: 'Sync Error'
    ,outlookLastSync: 'Last Sync'
    ,outlookReceivedCount: 'Received Messages'
    ,outlookReady: 'Ready'
    ,outlookSyncing: 'Syncing'
    ,outlookError: 'Error'
    ,outlookNewGroup: 'New Group'
    ,outlookNewTag: 'New Tag'
    ,outlookName: 'Name'
    ,outlookAccounts: 'Accounts'
    ,outlookNoAccounts: 'No Outlook accounts'
